...
- [.NET Core SDK](https://dotnet.microsoft.com/download) 2.1
...
- In a terminal, navigate to `corebotcs`

    ```bash
    # change into project folder
    cd corebotcs/CoreBot
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `corebotcs/CoreBot` folder
...
Generated with `dotnet new corebot` v4.5.1
